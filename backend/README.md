...
## Project Structure
    ...
    ├── interview_emerald_32467  # Django project configurations
...
1. Clone this repo and `cd interview_emerald_32467`
...
2. Clone this repo and `cd interview_emerald_32467`
